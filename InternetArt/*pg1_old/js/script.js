...
// function addFilter1(){video.style.filter = "hue-rotate(25deg); brightness(0.42); saturate(42%);";};
function addFilter1(){video.style.filter = "hue-rotate(25deg);";};
function addFilter2(){video.style.filter = "hue-rotate(29deg)";};
function addFilter3(){video.style.filter = "hue-rotate(30deg)";};
function addFilter4(){video.style.filter = "hue-rotate(25deg)";};
function addFilter5(){video.style.filter = "hue-rotate(22deg)";};
function addFilter6(){video.style.filter = "hue-rotate(60deg)";};
function addFilter7(){video.style.filter = "hue-rotate(42deg)";};
function addFilter8(){video.style.filter = "hue-rotate(218deg)";};
// function addFilter9(){video.style.filter = "hue-rotate(245deg)";};
function addFilter9(){video.style.filter = "hue-rotate(245deg); brightness(0.29); saturate(31%)";};
