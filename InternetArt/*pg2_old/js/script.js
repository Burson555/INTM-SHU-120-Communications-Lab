...
function addFilter1(){video.style.filter = "hue-rotate(36deg)";};
function addFilter2(){video.style.filter = "hue-rotate(23deg)";};
function addFilter3(){video.style.filter = "hue-rotate(21deg)";};
function addFilter4(){video.style.filter = "hue-rotate(30deg)";};
function addFilter5(){video.style.filter = "hue-rotate(25deg)";};
function addFilter6(){video.style.filter = "hue-rotate(39deg)";};
function addFilter7(){video.style.filter = "hue-rotate(49deg)";};
function addFilter8(){video.style.filter = "hue-rotate(69deg)";};
function addFilter9(){video.style.filter = "hue-rotate(240deg)";};
