...
function addFilter1(){if (noFixedFilter) {mask.style.backgroundColor = "#65613E";}};
function addFilter2(){if (noFixedFilter) {mask.style.backgroundColor = "#686951";}};
function addFilter3(){if (noFixedFilter) {mask.style.backgroundColor = "#979A87";}};
function addFilter4(){if (noFixedFilter) {mask.style.backgroundColor = "#BDBA9E";}};
function addFilter5(){if (noFixedFilter) {mask.style.backgroundColor = "#A79C87";}};
function addFilter6(){if (noFixedFilter) {mask.style.backgroundColor = "#857B64";}};
function addFilter7(){if (noFixedFilter) {mask.style.backgroundColor = "#665B45";}};
function addFilter8(){if (noFixedFilter) {mask.style.backgroundColor = "#4E412F";}};
function addFilter9(){if (noFixedFilter) {mask.style.backgroundColor = "#403D3D";}};
