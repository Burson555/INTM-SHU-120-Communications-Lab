...
function addFilter1(){if (noFixedFilter) {mask.style.backgroundColor = "#6E5836";}};
function addFilter2(){if (noFixedFilter) {mask.style.backgroundColor = "#765A48";}};
function addFilter3(){if (noFixedFilter) {mask.style.backgroundColor = "#8A6653";}};
function addFilter4(){if (noFixedFilter) {mask.style.backgroundColor = "#8C7864";}};
function addFilter5(){if (noFixedFilter) {mask.style.backgroundColor = "#9B8474";}};
function addFilter6(){if (noFixedFilter) {mask.style.backgroundColor = "#8C7D61";}};
function addFilter7(){if (noFixedFilter) {mask.style.backgroundColor = "#8A815B";}};
function addFilter8(){if (noFixedFilter) {mask.style.backgroundColor = "#797A73";}};
function addFilter9(){if (noFixedFilter) {mask.style.backgroundColor = "#5D5D61";}};
