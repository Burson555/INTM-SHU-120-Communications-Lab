...
function clickFunc() {
  mask.style.height = videoContainerHeight + "px";
  mask.style.width = videoContainerHeight * 16 / 9 + "px";
...
function addFilter1(){if (noFixedFilter) {mask.style.backgroundColor = "#281E17";}};
function addFilter2(){if (noFixedFilter) {mask.style.backgroundColor = "#352312";}};
function addFilter3(){if (noFixedFilter) {mask.style.backgroundColor = "#4F3923";}};
function addFilter4(){if (noFixedFilter) {mask.style.backgroundColor = "#584232";}};
function addFilter5(){if (noFixedFilter) {mask.style.backgroundColor = "#5F534C";}};
function addFilter6(){if (noFixedFilter) {mask.style.backgroundColor = "#58583C";}};
function addFilter7(){if (noFixedFilter) {mask.style.backgroundColor = "#4B4027";}};
function addFilter8(){if (noFixedFilter) {mask.style.backgroundColor = "#323C4D";}};
function addFilter9(){if (noFixedFilter) {mask.style.backgroundColor = "#39374E";}};
