...
function addFilter1(){video.style.filter = "hue-rotate(54deg)";};
function addFilter2(){video.style.filter = "hue-rotate(62deg)";};
function addFilter3(){video.style.filter = "hue-rotate(69deg)";};
function addFilter4(){video.style.filter = "hue-rotate(54deg)";};
function addFilter5(){video.style.filter = "hue-rotate(39deg)";};
function addFilter6(){video.style.filter = "hue-rotate(42deg)";};
function addFilter7(){video.style.filter = "hue-rotate(44deg)";};
function addFilter8(){video.style.filter = "hue-rotate(35deg)";};
function addFilter9(){video.style.filter = "hue-rotate(0deg)";};
